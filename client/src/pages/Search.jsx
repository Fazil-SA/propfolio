        ...
        <div className='p-7 border-b-2 sm:border-r-2 md:min-h-screen'>
            <form onSubmit={handleSubmit} className='flex flex-col gap-8'>
                ...
                <div className='flex gap-2 flex-wrap items-center'>
                    ...
                    <div className="flex gap-2">
                        <input type="checkbox" checked={sidebardata.type === 'rent'} onChange={handleChange} id='rent' className='w-5' />
                        <span>Rent</span>
                    </div>
                    <div className="flex gap-2">
                        <input type="checkbox" checked={sidebardata.type === 'sale'} onChange={handleChange} id='sale' className='w-5' />
                        <span>Sale</span>
                    </div>
                    <div className="flex gap-2">
                        <input type="checkbox" checked={sidebardata.offer} onChange={handleChange} id='offer' className='w-5' />
                        <span>Offer</span>
                    </div>
                </div>
                <div className='flex gap-2 flex-wrap items-center'>
